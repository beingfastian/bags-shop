...
function ProductDetails() {
  ...
  //     rating: 5,
  //     content:
  //       'Absolutely love these premium leather Bags! The craftsmanship is exceptional, and the quality exceeds my expectations. Perfect for professional and casual use.',
  //   },
  //   {
  //     id: 2,
      ...
      <div className="w-full">
        ...
        <div className="w-full flex flex-col items-center justify-center bg-white">
          <Image
            ...
            unoptimized
          />
          <div className="w-full sm:w-1/2 lg:w-1/3 py-8 relative">
              ...
              <div className="w-full flex flex-col lg:flex-row lg:justify-between">
                <div className="w-full lg:w-1/2 flex flex-col py-5">
                  <ProductsInfo
                    ...
                    data={data}
                    location="Islamabad"
                    onContactUs={() => router.push('/contact')}
