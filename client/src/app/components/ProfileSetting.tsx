...
const ClientProfile = () => {
  ...
  //   profileImage: '/profileSetting.jpg',
  //   firstName: 'John',
  //   lastName: 'Doe',
  ...
  const [userData, setUserData] = useState<{ profile?: string; email?: string; display_name?: string } | null>(null);
              ...
              <div className="w-full rounded-[6px] bg-white shadow-lg px-4 py-2">
                ...
                <div className="w-full flex flex-wrap mt-2">
                  ...
                  <div className="md:w-1/2 w-full px-2">
                    ...
                    <div className="bg-gray-100 p-2 rounded-md">{userData?.display_name
                    }</div>
                  </div>
                </div>
