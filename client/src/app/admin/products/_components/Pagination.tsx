...
function Pagination({ totalPages, currentPage, onPageChange }: Props) {
  ...
  return (
    <div className="flex items-center">
      ...
      >
        <Image
          src="/productleftArrow/icons/color.png"
          alt=""
          width={10}
          height={10}
          unoptimized
      ...
      {currentPage + 2 < totalPages && (
        <>
          ...
          <button
            ...
            className="w-8 h-8 rounded-md text-[#5A607F]  hover:bg-gray-200"
          >
            {totalPages}
          </button>
        </>
      ...
      >
        <Image
          src="/productrightarrow/icons/color.png"
          alt=""
          width={10}
          height={10}
          unoptimized
